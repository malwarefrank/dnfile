...
def test_compressed_int():
    assert None == dnfile.utils.read_compressed_int(b"")
    assert None == dnfile.utils.read_compressed_int(None)
...
def test_struct_char():
    assert None == dnfile.utils.num_bytes_to_struct_char(42)
    ...
    assert None == dnfile.utils.num_bytes_to_struct_char(0)
